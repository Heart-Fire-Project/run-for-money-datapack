...
execute as @a[team=circular] positioned as @s if entity @a[team=run,distance=..5] unless data entity @s ActiveEffects[{Id:24b}] run tellraw @a[team=hunter] ["",{"text":"[通知]","bold":true,"color":"gold"},"通报部队 找到逃亡者了"]
