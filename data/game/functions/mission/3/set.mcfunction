...
function game:mission/3/give
scoreboard players remove 任務数 time 1
bossbar set minecraft:time players @a[team=!hunter]
function game:mission/summon10
execute if score 地圖 temp matches 1 run function game:mission/3/map/1/random
execute if score 地圖 temp matches 2 run function game:mission/3/map/2/random
execute if score 地圖 temp matches 3 run function game:mission/3/map/3/random
scoreboard players set m3_tick temp 1
