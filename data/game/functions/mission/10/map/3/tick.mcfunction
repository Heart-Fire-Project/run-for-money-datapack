...
execute positioned 387 50 45 if block ~1 ~1 ~ minecraft:lever[powered=true] run tellraw @a[team=!hunter] ["",{"text":"[通知]","bold":true,"color":"gold"},{"text":"商圈區 中间馬路 的裝置以關閉","bold":true}]
