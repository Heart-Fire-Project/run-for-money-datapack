...
execute if score 隨機 temp matches 1 run give @a[team=!hunter] written_book{pages:["[\"\",{\"text\":\"監獄旁\",\"bold\":true}]"],title:"裝置位置",author:"遊戲總部"}
execute if score 隨機 temp matches 2 run give @a[team=!hunter] written_book{pages:["[\"\",{\"text\":\"紫區二樓玻璃窗\",\"bold\":true}]"],title:"裝置位置",author:"遊戲總部"}
execute if score 隨機 temp matches 3 run give @a[team=!hunter] written_book{pages:["[\"\",{\"text\":\"綠區二樓玻璃窗\",\"bold\":true}]"],title:"裝置位置",author:"遊戲總部"}
execute if score 隨機 temp matches 4 run give @a[team=!hunter] written_book{pages:["[\"\",{\"text\":\"藍區二樓玻璃窗\",\"bold\":true}]"],title:"裝置位置",author:"遊戲總部"}
execute if score 隨機 temp matches 5 run give @a[team=!hunter] written_book{pages:["[\"\",{\"text\":\"粉綠區二樓 安全門裡\",\"bold\":true}]"],title:"裝置位置",author:"遊戲總部"}
execute if score 隨機 temp matches 6 run give @a[team=!hunter] written_book{pages:["[\"\",{\"text\":\"開場遊戲旁\",\"bold\":true}]"],title:"裝置位置",author:"遊戲總部"}
