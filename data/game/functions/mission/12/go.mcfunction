...
execute if score 任務時限 time matches 0 run function game:mission/12/end
execute if score 任務時限 time matches 1.. run schedule function game:mission/12/go 1s append