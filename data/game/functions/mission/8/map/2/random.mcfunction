...
execute if score 隨機 temp matches 1 run clone 120 12 129 120 11 130 417 50 247
execute if score 隨機 temp matches 2 run clone 120 12 129 119 11 129 542 50 204
execute if score 隨機 temp matches 3 run clone 120 12 129 120 11 130 572 50 183
execute if score 隨機 temp matches 4 run clone 120 12 129 120 11 130 572 56 183
execute if score 隨機 temp matches 5 run clone 120 12 129 120 11 128 479 50 231
execute if score 隨機 temp matches 6 run clone 120 12 129 120 11 128 479 56 231
execute if score 隨機 temp matches 7 run clone 120 12 129 121 11 129 535 50 102
execute if score 隨機 temp matches 8 run clone 120 12 129 121 11 129 535 56 102
execute if score 隨機 temp matches 9 run clone 120 12 129 121 11 129 435 56 279
execute if score 隨機 temp matches 10 run clone 120 12 129 119 11 129 483 56 136
...
execute if score 抽取 temp matches 1.. run function game:mission/6/map/2/random