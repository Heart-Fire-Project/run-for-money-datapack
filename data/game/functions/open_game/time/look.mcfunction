...
execute unless score 體內秒 temp matches 12 run tellraw @a ["",{"text":"體內計時","bold":true,"color":"gold"},"結果為",{"score":{"name":"體內秒","objective":"temp"},"bold":true},{"text":".","bold":true},{"score":{"name":"顯示刻","objective":"temp"},"bold":true},"\n",{"text":"挑戰失敗 獵人放出","color":"red"}]
