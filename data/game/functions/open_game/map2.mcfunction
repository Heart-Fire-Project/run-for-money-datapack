...
execute if score 開場遊戲 temp matches 0 run clone 118 35 85 126 31 117 413 49 213
execute if score 開場遊戲 temp matches 1 run clone 130 35 85 138 31 117 413 49 213
execute if score 開場遊戲 temp matches 2 run clone 142 35 85 150 31 117 413 49 213
execute if score 開場遊戲 temp matches 3 run clone 162 35 85 154 31 117 413 49 213
