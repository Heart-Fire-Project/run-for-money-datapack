...
execute if score 投擲 temp matches 2.. run tellraw @a ["",{"text":"[骰子]","bold":true,"color":"gold"},{"score":{"name":"投擲","objective":"temp"},"bold":true,"color":"aqua"},"...","\n"," "," "," "," "," "," ","......"]
execute if score 投擲 temp matches 1 run tellraw @a ["",{"text":"[骰子]","bold":true,"color":"gold"},{"text":"獵人之眼","bold":true,"color":"dark_red"},"...","\n"," "," "," "," "," "," ","......"]
