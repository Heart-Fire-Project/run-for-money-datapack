...
tellraw @a ["",{"text":"[简讯] ","bold":true,"color":"gold"},{"selector":"@a[team=run,scores={time=600..}]"},"自首成功 ",{"text":"获得奖金","bold":true,"color":"gold"},{"score":{"name":"自首獎金","objective":"money"},"color":"gold"},{"text":"元","bold":true,"color":"gold"}]

execute if entity @a[team=run,tag=team1,scores={time=600..}] run tellraw @a ["",{"text":"[简讯] ","bold":true,"color":"gold"},"他的伙伴 ",{"selector":"@a[tag=team1,scores={time=..599}]"},"一起 ",{"text":"获得奖金","bold":true,"color":"gold"},{"score":{"name":"自首獎金","objective":"money"},"color":"gold"},{"text":"元","bold":true,"color":"gold"}]
execute if entity @a[team=run,tag=team2,scores={time=600..}] run tellraw @a ["",{"text":"[简讯] ","bold":true,"color":"gold"},"他的伙伴 ",{"selector":"@a[tag=team2,scores={time=..599}]"},"一起 ",{"text":"获得奖金","bold":true,"color":"gold"},{"score":{"name":"自首獎金","objective":"money"},"color":"gold"},{"text":"元","bold":true,"color":"gold"}]
execute if entity @a[team=run,tag=team3,scores={time=600..}] run tellraw @a ["",{"text":"[简讯] ","bold":true,"color":"gold"},"他的伙伴 ",{"selector":"@a[tag=team3,scores={time=..599}]"},"一起 ",{"text":"获得奖金","bold":true,"color":"gold"},{"score":{"name":"自首獎金","objective":"money"},"color":"gold"},{"text":"元","bold":true,"color":"gold"}]
execute if entity @a[team=run,tag=team4,scores={time=600..}] run tellraw @a ["",{"text":"[简讯] ","bold":true,"color":"gold"},"他的伙伴 ",{"selector":"@a[tag=team4,scores={time=..599}]"},"一起 ",{"text":"获得奖金","bold":true,"color":"gold"},{"score":{"name":"自首獎金","objective":"money"},"color":"gold"},{"text":"元","bold":true,"color":"gold"}]
