...
execute if score 隨機任務 temp matches 1 if score 任務開始 temp matches 0 if score 任務間隔 time matches 0 if score 任務數 time matches 1.. run function game:mission/random
execute if score 隨機任務 temp matches 1 if score 任務間隔 time matches 0 run function game:time/random_misson_time
execute if score 隨機任務 temp matches 1 if score 任務開始 temp matches 0 if score 任務數 temp matches 1.. if score 任務間隔 time matches 3 as @r run function game:ring
